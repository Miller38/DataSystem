...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    public RegistrarUsuarios() {
        ...
        initComponents();
        // Recuperamos el usuario que viene desde la interfaz de login.
        user = Login.user;
        
        
        setTitle("Registar Nuevo usuario - Sesion usuario " + user );
        setSize(630,350);
        setResizable(false);
        ...
        // Evita que el programa finalice al cerrar esta interfaz.
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 210, 20));
        ...
        getContentPane().add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, 210, 20));
        ...
        getContentPane().add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, 210, 20));

        cmb_niveles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Capturista", "Tecnico" }));
        getContentPane().add(cmb_niveles, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 110, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                // JO personalizado 
                JOptionPane.showMessageDialog(null, "<html><p style=\"color:red;font-size:12px;\">Nombre de usuario no disponible" +"</p></html>",
                ...
                if(validacion == 0){
                    ...
                    try {
                        ...
                        //LLamamos el metodo para limpiar los campos
                        Limpiar();
                        ...
                        // JO personalizado
                        JOptionPane.showMessageDialog(null, "<html><p style=\"color:green;font-size:18px;\">Registrado exitosamente." +"</p></html>",
                        "Aviso", JOptionPane.PLAIN_MESSAGE, icono("/images/ok.png", 50 ,50));

                        // Metodo para eliminar objetos y liberar recursos
                        // Cierra la interfaz al terminar el registro de un usuario nuevo
                        this.dispose();
                        ...
                        System.err.println("Error en registrar usuario");
                         // JO personalizado
                          JOptionPane.showMessageDialog(null,  "<html><p style=\"color:red;font-size:12px;\">Error al registar usuario , Contacte al Administrador." +"</p></html>",
                    "advertencia", JOptionPane.PLAIN_MESSAGE, icono("/images/Advertencia.png", 30 ,30));

                    }
                
                } else {
                     // JO personalizado
                     JOptionPane.showMessageDialog(null, "<html><p style=\"color:red;font-size:18px;\">Debes llenar todos los campos." +"</p></html>",
                    "advertencia", JOptionPane.PLAIN_MESSAGE, icono("/images/advertencia.png", 30 ,30));
            ...
            // JO personalizado
            JOptionPane.showMessageDialog(null, "Error alcomparar usuario , Contacte al Administrador.",
                    "advertencia", JOptionPane.PLAIN_MESSAGE, icono("/images/DS.png", 30 ,30));
        }
